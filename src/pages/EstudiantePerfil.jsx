...
const UserProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`https://rest-server-v2.onrender.com/estudiante/${id}`);
    ...
    const handleToggleStatus = () => {
        ...
        axios
          .put(`https://rest-server-v2.onrender.com/estudiante/${id}/cambiar-estatus`, { estatus: updatedStatus })
          .then((response) => {
    ...
    return (
        <div className="overflow-hidden bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
                ...
                <div className="flex items-center justify-between">
                    <img className="w-20 h-20 rounded-full" src={`https://rest-server-v2.onrender.com/${user.imagenPerfil}`} alt="Imagen de perfil" />
                                ...
                                <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                    ...
                                    <div className="ml-4 flex-shrink-0">
                                        <img
                                            ...
                                            src={`https://rest-server-v2.onrender.com/${user.imagenDocumento}`} alt="img" />
                                    </div>
                                </li>
                                <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                    <div className="flex w-0 flex-1 items-center">
                                    ...
                                    <div className="ml-4 flex-shrink-0">
                                        <img
                                            className="inline-flex border rounded-md border-gray-100 dark:border-gray-600 w-24 max-h-24 p-2 m-2"
                                            src={`https://rest-server-v2.onrender.com/${user.imagenVoleto}`} alt="img" />
                                    </div>
                                </li>
                                <li className="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                    <div className="flex w-0 flex-1 items-center">
                                    ...
                                    <div className="ml-4 flex-shrink-0">
                                        <img
                                            className="inline-flex border rounded-md border-gray-100 dark:border-gray-600 w-24 max-h-24 p-2 m-2"
                                            src={`https://rest-server-v2.onrender.com/${user.imagenPermiso}`} alt="img" />
                                    </div>
                                </li>
                            </ul>
                        </dd>
        ...
        //   <img src={`https://rest-server-v2.onrender.com/${user.imagenDocumento}`} alt="img" />
        //   <img src={`https://rest-server-v2.onrender.com/${user.imagenVoleto}`} alt="img" />
        //   <img src={`https://rest-server-v2.onrender.com/${user.imagenPermiso}`} alt="img" />
