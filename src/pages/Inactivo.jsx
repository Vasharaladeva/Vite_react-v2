...
const Inactivo = () => {
    ...
    useEffect(() => {
        axios.get(`https://rest-server-v2.onrender.com/estudianteina`)
            .then((response) => {
    ...
    const handleChangeStatus = () => {
        axios.put('https://rest-server-v2.onrender.com/estudiante/cambiar-estatus')
            .then((response) => {
                                                                ...
                                                                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                                                    <div className="flex items-center">
                                                                        <div className="h-10 w-10 flex-shrink-0">
                                                                            <img className="h-10 w-10 rounded-full" src={`https://rest-server-v2.onrender.com/${person.imagenPerfil}`} alt="" />
                                                                        </div>
                                                                        <div className="ml-4">
